...
/*以下是根据 ReportPages 和 PowerBIUsers 设置的模板无需更改 */
VAR PowerBIUsers = 
...
VAR pageOrdinal = 0
/*以下是根据 ReportPages.json 设置的模板无需更改 */
VAR page = 
    FILTER( ALL( C02_ReportPages ), C02_ReportPages[Ordinal] = pageOrdinal )
...
/* 
1、在页面筛选器上添加筛选字段:C02_ReportPages[ordinal] 
2、筛选选择单选,选择当前页面的 ordinal .
*/
VAR pageOrdinal = 0
VAR page = 
    FILTER( ALL( C02_ReportPages ), C02_ReportPages[Ordinal] = pageOrdinal )
